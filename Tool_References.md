...
[Emsisoft Emergency Kit](https://dl.emsisoft.com/EmsisoftEmergencyKit.exe) - "A scanner that can be used without installation to scan and clean infected computers". Uses Bitdefender + Emsisoft signatures - Pseudo Installation Required. \
...
[Norton Power Eraser](https://www.norton.com/npe_latest) - "Eliminates deeply embedded and difficult-to-detect crimeware that traditional virus scanning doesn’t always detect.". Great for Rootkits. No installation required \
...
[Microsoft Safety Scanner](https://learn.microsoft.com/en-us/defender-endpoint/safety-scanner-download) - " A tool designed to find and remove malware from Windows computers". Same signatures as Windows Defender. No installation required. \
