...
[Emsisoft Remediation Kit](https://dl.emsisoft.com/EmsisoftRemediationKit.exe) - "A command line and UI based toolkit for Malware detection and remediation" - Pseudo Installation Required. \
